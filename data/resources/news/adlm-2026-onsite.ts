...
> = {
  "zh-CN": {
    ...
    seoTitle:
      "ADLM 2026现场直击｜恒永达4105号展位｜Foreach Technology",
    seoDescription:
  ...
  en: {
    ...
    seoTitle:
      "Live from ADLM 2026 | Foreach Technology at Booth 4105",
    seoDescription:
  ...
  es: {
    ...
    seoTitle:
      "En directo desde ADLM 2026 | Foreach Technology en el stand 4105",
    seoDescription:
  ...
  fr: {
    ...
    seoTitle:
      "En direct de l’ADLM 2026 | Foreach Technology au stand 4105",
    seoDescription:
  ...
  ru: {
    title:
      "ADLM 2026: репортаж с выставки | Foreach Technology на стенде 4105",
    summary:
    ...
    seoTitle:
      "ADLM 2026: репортаж с выставки | Foreach Technology, стенд 4105",
    seoDescription:
