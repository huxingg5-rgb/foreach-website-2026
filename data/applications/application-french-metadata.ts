...
> = {
  "analytical-instruments": {
    title: "Solutions fluidiques pour instruments analytiques | Foreach Technology",
    description:
  ...
  "environmental-monitoring": {
    title: "Solutions fluidiques pour la surveillance environnementale | Foreach Technology",
    description:
  ...
  "lab-automation": {
    title: "Solutions fluidiques pour l’automatisation de laboratoire | Foreach Technology",
    description:
  ...
  "life-science": {
    title: "Solutions fluidiques pour les sciences de la vie | Foreach Technology",
    description:
  ...
  "synthetic-biology": {
    title: "Solutions fluidiques pour la biologie synthétique | Foreach Technology",
    description:
