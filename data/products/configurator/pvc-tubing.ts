...
export const pvcTubingVariants:
  ProductConfiguratorVariant[] = [
  {
    id: "438001",
    model: "M3602002",
...
export const pvcTubingConfigurator:
  ProductConfiguratorConfig = {
  id: "pvc-tubing",
  title: "PVC管尺寸选型",
  description:
  ...
  noticeTitle: "批量定制说明：",
  notice:
    "如采购数量较大，可支持特殊硬度、内外径、单卷长度及其他规格定制，具体起订量与交期请联系我们确认。",
};

/* PVC_CONFIGURATOR_ENGLISH_CONFIG_START */

function translatePackagingToEnglish(
  value: unknown
): string {
  return String(value || "")
    .replace("米/卷", " m/roll");
...
export const pvcTubingConfiguratorEn:
  ProductConfiguratorConfig = {
  ...pvcTubingConfigurator,

  id: "pvc-tubing-en",

  title: "PVC Tubing Size Selector",
  ...
  variants: pvcTubingVariants.map(
    (variant) => ({
      ...variant,
      result: {
        ...variant.result,
        packaging:
          translatePackagingToEnglish(
  ...
  notice:
    "For higher-volume orders, special hardness, inner and outer diameters, roll lengths, and other specifications can be customized. Please contact us to confirm MOQ and lead time.",
...
/* PVC_CONFIGURATOR_ENGLISH_CONFIG_END */
