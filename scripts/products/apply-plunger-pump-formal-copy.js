...
cardRows = upsertRows(cardRows, ["productId"], [
  {
    ...
    databasePreviewHref: "/products/pumps-db/plunger-pumps/standard-piston-pump/ea-100-pmma",
    showInSelection: "yes",
    sort: 100,
  },
  {
    ...
    databasePreviewHref: "/products/pumps-db/plunger-pumps/standard-piston-pump/ea-250-pmma",
    showInSelection: "yes",
    sort: 110,
  },
  {
    ...
    databasePreviewHref: "/products/pumps-db/plunger-pumps/miniature-piston-pump/sm-100-pmma",
    showInSelection: "yes",
    sort: 200,
  },
]);
