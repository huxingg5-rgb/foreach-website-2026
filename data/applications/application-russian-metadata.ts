...
> = {
  "analytical-instruments": {
    title: "Жидкостные решения для аналитических приборов | Foreach Technology",
    description:
  ...
  "environmental-monitoring": {
    title: "Жидкостные решения для экологического мониторинга | Foreach Technology",
    description:
  ...
  "lab-automation": {
    title: "Жидкостные решения для лабораторной автоматизации | Foreach Technology",
    description:
  ...
  "life-science": {
    title: "Жидкостные решения для наук о жизни | Foreach Technology",
    description:
  ...
  "synthetic-biology": {
    title: "Жидкостные решения для синтетической биологии | Foreach Technology",
    description:
