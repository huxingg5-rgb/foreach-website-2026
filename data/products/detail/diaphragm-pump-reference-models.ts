...
> = {
  ...
  en: {
    ...
    gasLiquid: "Gas-Liquid Diaphragm Pumps",
    gas: "Gas Diaphragm Pumps",
    modelLabel: "Model:",
  ...
  es: {
    ...
    gasLiquid: "Bombas de diafragma gas-líquido",
    gas: "Bombas de diafragma para gases",
    modelLabel: "Modelo:",
  ...
  fr: {
    ...
    gasLiquid: "Pompes à membrane gaz-liquide",
    gas: "Pompes à membrane pour gaz",
    modelLabel: "Modèle :",
  ...
  ru: {
    ...
    gasLiquid: "Газожидкостные мембранные насосы",
    gas: "Газовые мембранные насосы",
    modelLabel: "Модель:",
