...
/* =========================================================
   SyntheticBiologyApplicationClient.tsx
   恒永达官网｜合成生物应用领域交互组件
========================================================= */
...
import type {
  ...
  SyntheticBiologyApplicationType,
  SyntheticBiologyFluidicModule,
} from "@/data/applications/synthetic-biology/synthetic-biology-application.types";

type SyntheticBiologyApplicationClientProps = {
  data: SyntheticBiologyApplicationPageData;
};
...
export default function SyntheticBiologyApplicationClient({
  data,
}: SyntheticBiologyApplicationClientProps) {
  ...
  const activeApplication = useMemo<SyntheticBiologyApplicationType>(() => {
    return (
  ...
  const activeModule = useMemo<SyntheticBiologyFluidicModule>(() => {
    return (
  ...
  function handleApplicationChange(application: SyntheticBiologyApplicationType) {
  ...
  function handleModuleChange(module: SyntheticBiologyFluidicModule) {
    setActiveModuleKey(module.key);
    setActiveProductKey(module.products[0] ?? "");
  }

  return (
    <main className="ivd-page synthetic-biology-page">
      ...
      <section className="ivd-section" id="applications">
        <div className="ivd-section-inner">
          ...
          <div className="ivd-instrument-tabs" role="tablist" aria-label="合成生物类型">
