...
export const datasheetZhItems: DatasheetItem[] = [
  ...
  },
  {
    ...
    productHref: "/products/pumps/diaphragm-pumps/dpl30-liquid-diaphragm-pump",
    downloadHref:
      "/downloads/resources/datasheets/zh-CN/Pumps/ps-150b-2412-00001-a04-cn-dpl30-diaphragm-pump.pdf",
    actionType: "download",
  },
  {
    id: "dpl60-diaphragm-pump",
    category: "pump",
    keywords: "DPL60 隔膜泵 diaphragm pump 600 mL/min 自吸 供液 废液",
    title: "DPL60 隔膜泵规格书",
    label: "泵系列",
    language: "中文",
    version: "A02",
    update: "2026-07",
    description: "DPL60 隔膜泵适用于自动化仪器中流量要求更高的供液、清洗循环、废液抽排与液体输送。",
    image:
      "/images/products/pumps/diaphragm-pumps/dpl60/images/dpl60-brushed-liquid-diaphragm-pump-main.webp",
    productHref: "/products/pumps/diaphragm-pumps/dpl60-liquid-diaphragm-pump",
    downloadHref:
      "/downloads/resources/datasheets/zh-CN/Pumps/ps-150b-2412-00002-a02-cn-dpl60-diaphragm-pump.pdf",
    actionType: "download",
  },
  {
    id: "dpl30h-diaphragm-pump",
    category: "pump",
    keywords: "DPL30H 高压隔膜泵 diaphragm pump 300 mL/min 600 kPa 自吸",
    title: "DPL30H 高压隔膜泵规格书",
    label: "泵系列",
    language: "中文",
    version: "A00",
    update: "2026-03",
    description: "DPL30H 高压隔膜泵适用于对出口压力要求更高的自动化仪器液路，可用于供液、预充和液体输送。",
    image:
      "/images/products/pumps/diaphragm-pumps/dpl30h/images/dpl30h-brushed-liquid-diaphragm-pump-main.webp",
    productHref: "/products/pumps/diaphragm-pumps/dpl30h-liquid-diaphragm-pump",
    downloadHref:
      "/downloads/resources/datasheets/zh-CN/Pumps/ps-150b-2504-00001-a00-cn-dpl30h-high-pressure-liquid-diaphragm-pump.pdf",
    actionType: "download",
  },
  {
    id: "dpgl800-gas-liquid-diaphragm-pump",
    category: "pump",
    keywords: "DPGL800 气液混合隔膜泵 diaphragm pump 6 L/min 负压 抽吸 废液",
    title: "DPGL800 气液混合隔膜泵规格书",
    label: "泵系列",
    language: "中文",
    version: "A00",
    update: "2026-03",
    description: "DPGL800 气液混合隔膜泵适用于气体抽吸、负压建立、气液混合物抽排及仪器废液处理。",
    image:
      "/images/products/pumps/diaphragm-pumps/dpgl800/images/dpgl800-gas-liquid-diaphragm-pump-main.webp",
    productHref: "/products/pumps/diaphragm-pumps/dpgl800-gas-liquid-diaphragm-pump",
    downloadHref:
      "/downloads/resources/datasheets/zh-CN/Pumps/ps-150b-2506-00001-a00-cn-dpgl800-gas-liquid-diaphragm-pump.pdf",
    actionType: "download",
  },
  {
