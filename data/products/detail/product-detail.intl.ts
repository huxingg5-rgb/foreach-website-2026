...
const NARRATIVE_EXACT_TRANSLATIONS: Record<string, string> = {
  ...
  "DPL30 系列空载流量为 300 mL/min，额定压力为 100 kPa，自吸高度为 6 mH₂O，提供有刷电机和无刷电机两种标准型号配置。用户可根据设备运行时间、寿命要求和成本需求直接选择对应型号；如需 12V 电压、FF/PS 材质组合或其他接口方向，可在型号配置中进一步确认。":
    "The DPL30 series has a no-load flow rate of 300 mL/min, a rated pressure of 100 kPa, and a self-priming lift of 6 mH₂O. Brushed-motor and brushless-motor standard model configurations are available. Users can select the appropriate model based on equipment operating time, service-life requirements, and cost requirements. For 12 V operation, an FF/PS material combination, or another port orientation, confirm the model configuration for the specific project.",
  "DPL30 液体隔膜泵适合哪些应用？":
...
const ACTUAL_SPECIFICATION_VALUE_TRANSLATIONS: Record<string, string> = {
  "卡套接头，连接 6×4 mm（外径×内径）的硬管": "Threaded Port, connects to 6 × 4 mm rigid tubing",
  "气体、气液混合物": "Gas, gas-liquid mixture",
  "\u5341\u5b57\u578b": "Cross-Shaped",
...
const SOURCE_ALIGNED_NARRATIVE_TRANSLATIONS: Record<string, string> = {
  ...
  "DPGL800 气液混合隔膜泵是一款适用于气体抽吸、负压建立和气液混合物抽排的无刷隔膜泵，可用于仪器内部负压抽吸模块、废液与气体混合抽排、密闭容器抽气和气路辅助输送等场景。该系列专为气体及气液混合物设计，不适用于输送 100% 液体，适合需要同时考虑气体流量、负压能力和系统集成空间的设备应用。\n\nDPGL800 采用 24V 无刷电机，单头空载流量为 6 L/min，最大正压为 30 kPa，最大负压＜-90 kPa，接口为 G1/8 内螺纹。对于需要较高负压能力、较大气体流量和气液混合物抽排能力的体外诊断设备、实验室自动化设备和分析检测系统，DPGL800 可作为气液混合隔膜泵和负压抽吸泵方案进行集成。": "The DPGL800 gas-liquid diaphragm pump is a brushless pump designed for gas aspiration, negative-pressure generation, and gas-liquid mixture evacuation. It can be used in instrument-internal negative-pressure modules, mixed gas-liquid waste evacuation, closed-vessel air extraction, and auxiliary gas-path delivery. Designed for gas and gas-liquid mixtures. It is not suitable for pumping 100% liquid.\n\nThe DPGL800 uses a 24 V brushless motor and provides a no-load gas flow rate of 6 L/min per head, a maximum positive pressure of 30 kPa, a maximum negative pressure of < -90 kPa, and a G1/8 female-thread interface. For IVD equipment, laboratory automation equipment, and analytical testing systems requiring high vacuum, higher gas flow, and gas-liquid mixture evacuation, the DPGL800 can be integrated as a gas-liquid diaphragm pump and vacuum-aspiration solution.",
