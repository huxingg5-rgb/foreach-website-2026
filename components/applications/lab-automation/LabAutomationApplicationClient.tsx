...
/* =========================================================
   LabAutomationApplicationClient.tsx
   恒永达官网｜实验室自动化应用领域交互组件
   ...
   2. 内容和数据独立维护在 data/applications/lab-automation/
   3. 支持 URL 参数 ?application=xxx 自动选中自动化设备类型
   4. 面包屑使用全站统一 SiteBreadcrumb
========================================================= */
...
import type {
  ...
  LabAutomationApplicationType,
  LabAutomationFluidicModule,
} from "@/data/applications/lab-automation/lab-automation-application.types";

type LabAutomationApplicationClientProps = {
  data: LabAutomationApplicationPageData;
};
...
export default function LabAutomationApplicationClient({ data }: LabAutomationApplicationClientProps) {
  ...
  const activeApplication = useMemo<LabAutomationApplicationType>(() => {
    return (
  ...
  const activeModule = useMemo<LabAutomationFluidicModule>(() => {
    return (
  ...
  function handleApplicationChange(application: LabAutomationApplicationType) {
  ...
  function handleModuleChange(module: LabAutomationFluidicModule) {
    setActiveModuleKey(module.key);
    setActiveProductKey(module.products[0] ?? "");
  }

  return (
    <main className="ivd-page lab-automation-page">
      {/* =====================================================
          Banner
      ===================================================== */}
      ...
      <section className="ivd-section" id="applications">
        <div className="ivd-section-inner">
          ...
          <div className="ivd-instrument-tabs" role="tablist" aria-label="实验室自动化设备类型">
