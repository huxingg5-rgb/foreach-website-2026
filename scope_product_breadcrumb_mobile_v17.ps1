...
try {
  ...
  # =======================================================
  # 4. Remove the shared global offset from V15/V16.
  #    Replace it with page-specific breadcrumb rules.
  # =======================================================
...
'@
  ...
  Write-Host "Other SitePageShell pages are no longer affected." -ForegroundColor Green
  ...
  Write-Host " - Removed the shared V15/V16 breadcrumb override"
