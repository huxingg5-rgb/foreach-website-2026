  ...
  en: {
    category: {
      ...
      paragraphs: [
        ...
        "EA head options include acrylic (PMMA), PCTG copolyester and PEEK; piston options include zirconia ceramic, alumina ceramic, PEEK and sapphire. SM head options include acrylic (PMMA), polysulfone (PSU), acetal (POM) and PEEK; piston options include ceramic, stainless steel and PEEK. TM displays an acrylic (PMMA) head and ceramic piston, with other materials assessed per project. Check heads, pistons, seals and valves together; whole-path light protection needs a separate design assessment. Learn more in the [piston-pump head material selection guide](/en/resources/technical-articles/piston-pump-head-material-selection/).",
    ...
    ea: {
      ...
      paragraphs: [
        ...
        "Head options include acrylic (PMMA), PCTG copolyester and PEEK; piston options include zirconia ceramic, alumina ceramic, PEEK and sapphire. Other engineering materials are assessed against fluid, structural and project requirements. Check seals and valves together; a PEEK head alone does not guarantee compatibility of all wetted parts or light protection for the entire fluid path.",
    ...
    sm: {
      ...
      paragraphs: [
        ...
        "Displayed configurations use acrylic (PMMA) or PEEK heads. Head options include acrylic (PMMA), polysulfone (PSU), acetal (POM) and PEEK; piston options include ceramic, stainless steel and PEEK. Heads, pistons, seals and valves must be matched together to the fluid. Whole-path light protection requires a separate design assessment.",
    ...
    tm: {
      ...
      paragraphs: [
        "Foreach TM ultra-compact piston pumps display acrylic (PMMA) head configurations of 50 μL, 100 μL, 250 μL and 500 μL for space-constrained OEM analytical modules. Tasks include microliter reagent addition, sample dispensing, reaction-liquid addition and metered buffer transfer.",
        ...
        "The displayed version uses an acrylic (PMMA) head and ceramic piston. Other materials are assessed against reagent chemistry, seals and structural space. Mounting, tubing, valves and drive control are project-specific; accuracy, repeatability, working pressure and life require validation of the selected configuration and actual conditions.",
