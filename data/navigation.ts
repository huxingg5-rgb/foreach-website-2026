      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Genómica / Preparación de muestras",
            "Génomique / Préparation des échantillons",
            "유전체 분석 / 샘플 전처리",
            "Геномика / Подготовка образцов",
          ),
          t(
            "裂解、结合、清洗、洗脱与低残留液路",
            "Lysis, binding, washing, elution and low-residue fluidic paths",
            "Lisis, unión, lavado, elución y circuitos fluídicos de bajo residuo",
            "Lyse, liaison, lavage, élution et circuits fluidiques à faible résidu",
            "용해, 결합, 세척, 용출 및 저잔류 유로",
            "Лизис, связывание, промывка, элюирование и тракты с низким остаточным объёмом",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Cultivo celular / Terapia celular",
            "Culture cellulaire / Thérapie cellulaire",
            "세포 배양 / 세포 치료",
            "Культивирование клеток / Клеточная терапия",
          ),
          t(
            "培养基补液、缓冲液切换与封闭式转移",
            "Media replenishment, buffer switching and closed fluid transfer",
            "Reposición de medios, conmutación de tampones y transferencia cerrada de fluidos",
            "Réapprovisionnement en milieu, commutation de tampons et transfert fluidique en circuit fermé",
            "배지 보충, 완충액 전환 및 폐쇄형 유체 이송",
            "Пополнение среды, переключение буферов и закрытый перенос жидкости",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Estación de automatización de laboratorio",
            "Station d’automatisation de laboratoire",
            "실험실 자동화 워크스테이션",
            "Станция лабораторной автоматизации",
          ),
          t(
            "移液、分液、清洗与多工位液路集成",
            "Pipetting, dispensing, washing and multi-station fluidic integration",
            "Pipeteo, dispensación, lavado e integración fluídica multiestación",
            "Pipetage, distribution, lavage et intégration fluidique multiposte",
            "피펫팅, 분주, 세척 및 다중 스테이션 유로 통합",
            "Пипетирование, дозирование, промывка и многопозиционная интеграция жидкостных трактов",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Análisis de proteínas / anticuerpos",
            "Analyse des protéines / anticorps",
            "단백질 / 항체 분석",
            "Анализ белков / антител",
          ),
          t(
            "样本进样、缓冲液切换与低吸附流路",
            "Sample injection, buffer switching and low-adsorption flow paths",
            "Inyección de muestras, conmutación de tampones y circuitos de baja adsorción",
            "Injection d’échantillons, commutation de tampons et circuits à faible adsorption",
            "샘플 주입, 완충액 전환 및 저흡착 유로",
            "Ввод образцов, переключение буферов и тракты с низкой адсорбцией",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Biología sintética / Bioprocesos",
            "Biologie synthétique / Bioprocédés",
            "합성생물학 / 바이오프로세스",
            "Синтетическая биология / Биопроцессы",
          ),
          t(
            "补料、取样、排液与过程状态监测",
            "Feeding, sampling, drainage and process status monitoring",
            "Alimentación, muestreo, drenaje y monitorización del estado del proceso",
            "Alimentation, prélèvement, vidange et surveillance de l’état du procédé",
            "공급, 샘플링, 배액 및 공정 상태 모니터링",
            "Подача, отбор проб, слив и контроль состояния процесса",
          ),
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Station de préparation des échantillons",
            "샘플 전처리 워크스테이션",
          ...
          t(
            ...
            "Pretratamiento de muestras, dosificación de reactivos, lavado, elución y drenaje de residuos",
            "Prétraitement des échantillons, dosage des réactifs, lavage, élution et évacuation des déchets",
            "샘플 전처리, 시약 분주, 세척, 용출 및 폐액 배출",
            "Пробоподготовка, дозирование реагентов, промывка, элюирование и слив отходов",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Plataforma automatizada de pipeteo",
            "Plateforme de pipetage automatisée",
            "자동 피펫팅 플랫폼",
            "Автоматизированная платформа пипетирования",
          ),
          t(
            "孔板、试管与反应腔之间的微量液体转移",
            "Micro-volume liquid transfer between plates, tubes and reaction chambers",
            "Transferencia de microlitros entre placas, tubos y cámaras de reacción",
            "Transfert de microvolumes entre plaques, tubes et chambres de réaction",
            "플레이트, 튜브 및 반응 챔버 간 미량 액체 이송",
            "Перенос микрообъёмов между планшетами, пробирками и реакционными камерами",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Sistemas de procesamiento de microplacas",
            "Systèmes de traitement des microplaques",
            "마이크로플레이트 처리 장비",
          ...
          t(
            ...
            "Dosificación en placas, lavado, aspiración de residuos líquidos y gestión de desechos",
            "Dosage sur plaques, lavage, aspiration des liquides résiduels et gestion des déchets",
            "플레이트 분주, 세척, 잔액 흡인 및 폐액 처리",
            "Дозирование в планшеты, промывка, аспирация остатков и удаление отходов",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Systèmes de distribution de réactifs",
            "시약 분주 장비",
          ...
          t(
            ...
            "Dosificación repetible de tampones, soluciones de lavado, medios y aditivos",
            "Dosage répétable de tampons, solutions de lavage, milieux et additifs",
            "완충액, 세척액, 배지 및 첨가액의 반복 정량 분주",
            "Повторяемое дозирование буферов, промывочных растворов, сред и добавок",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Intégration de systèmes d’automatisation",
            "자동화 시스템 통합",
          ...
          t(
            ...
            "Integración fluídica multimódulo, multiestación y multirruta con monitorización de estado",
            "Intégration fluidique multimodule, multiposte et multivoie avec surveillance d’état",
            "다중 모듈·스테이션·경로 유로 통합 및 상태 모니터링",
            "Интеграция многомодульных, многопозиционных и многоканальных трактов с контролем состояния",
          ),
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Cromatografía / Muestreador automático",
            "Chromatographie / Échantillonneur automatique",
            "크로마토그래피 / 오토샘플러",
            "Хроматография / Автосамплер",
          ),
          t(
            "样品进样、溶剂切换、清洗排废与低残留流路",
            "Sample injection, solvent switching, washing, waste drainage and low-residue flow paths",
            "Inyección de muestras, conmutación de disolventes, lavado, drenaje y circuitos de bajo residuo",
            "Injection d’échantillons, commutation de solvants, lavage, vidange et circuits à faible résidu",
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Espectroscopia / Análisis elemental",
            "Spectroscopie / Analyse élémentaire",
            "분광 분석 / 원소 분석",
            "Спектроскопия / Элементный анализ",
          ),
          t(
            "样品输送、试剂加入、清洗与废液排放",
            "Sample delivery, reagent dosing, washing and waste drainage",
            "Transporte de muestras, dosificación de reactivos, lavado y drenaje de residuos",
            "Acheminement des échantillons, dosage des réactifs, lavage et évacuation des déchets",
            "샘플 이송, 시약 분주, 세척 및 폐액 배출",
            "Подача образцов, дозирование реагентов, промывка и слив отходов",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Calidad del agua / Monitorización ambiental",
            "Qualité de l’eau / Surveillance environnementale",
            "수질 / 환경 모니터링",
            "Контроль качества воды / Экологический мониторинг",
          ),
          t(
            "取样、试剂分配、反应检测、清洗与排废",
            "Sampling, reagent dosing, reaction detection, washing and waste drainage",
            "Muestreo, dosificación de reactivos, detección de reacciones, lavado y drenaje",
            "Prélèvement, dosage des réactifs, détection de réaction, lavage et évacuation",
            "샘플링, 시약 분주, 반응 검출, 세척 및 폐액 배출",
            "Отбор проб, дозирование реагентов, регистрация реакции, промывка и слив",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Dilución, extracción, mezcla, filtración y control fluídico multirruta",
            "Dilution, extraction, mélange, filtration et commande fluidique multivoie",
            "희석, 추출, 혼합, 여과 및 다중 경로 유로 제어",
            "Разбавление, экстракция, смешивание, фильтрация и управление многоканальными трактами",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración de sistemas de análisis de laboratorio",
            "Intégration de systèmes d’analyse de laboratoire",
            "실험실 분석 시스템 통합",
            "Интеграция лабораторных аналитических систем",
          ),
          t(
            "多模块、多试剂、多检测路径的液路系统集成",
            "Fluidic system integration for multi-module, multi-reagent and multi-detection paths",
            "Integración fluídica para múltiples módulos, reactivos y rutas de detección",
            "Intégration fluidique pour plusieurs modules, réactifs et voies de détection",
            "다중 모듈·시약·검출 경로 유로 시스템 통합",
            "Интеграция трактов для нескольких модулей, реагентов и каналов детектирования",
          ),
      ...
      images: [
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Aguas residuales / Agua de proceso",
            "Eaux usées / Eaux de procédé",
            "폐수 / 공정수",
            "Сточные / Технологические воды",
          ),
          t(
            "复杂水样取送、过滤保护、试剂反应与排液维护",
            "Complex water sampling, filtration protection, reagent reaction and drainage maintenance",
            "Muestreo de aguas complejas, protección por filtración, reacción con reactivos y mantenimiento del drenaje",
            "Prélèvement d’eaux complexes, protection par filtration, réaction des réactifs et maintenance de la vidange",
            "복잡한 수질 샘플 이송, 여과 보호, 시약 반응 및 배액 유지보수",
            "Отбор сложных водных проб, фильтрационная защита, реакция реагентов и обслуживание слива",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Gases de combustión / Pretratamiento de gases",
            "Fumées / Prétraitement des gaz",
            "배기가스 / 가스 전처리",
            "Дымовые газы / Газоподготовка",
          ),
          t(
            "冷凝液排放、吸收液输送、清洗与防堵保护",
            "Condensate drainage, absorbent delivery, washing and anti-clogging protection",
            "Drenaje de condensado, suministro de absorbente, lavado y protección antiobstrucción",
            "Évacuation des condensats, alimentation en absorbant, lavage et protection anti-colmatage",
            "응축수 배출, 흡수액 이송, 세척 및 막힘 방지",
            "Отвод конденсата, подача поглотителя, промывка и защита от засорения",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Muestreo y pretratamiento ambiental",
            "Échantillonnage et prétraitement environnemental",
            "환경 샘플링 및 전처리",
            "Экологический отбор и пробоподготовка",
          ),
          t(
            "样品转移、稀释、过滤、混合与废液排放",
            "Sample transfer, dilution, filtration, mixing and waste drainage",
            "Transferencia, dilución, filtración y mezcla de muestras, y drenaje de residuos",
            "Transfert, dilution, filtration et mélange des échantillons, puis évacuation des déchets",
            "샘플 이송, 희석, 여과, 혼합 및 폐액 배출",
            "Перенос, разбавление, фильтрация и смешивание образцов, слив отходов",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración de sistemas ambientales en línea",
            "Intégration de systèmes environnementaux en ligne",
            "환경 온라인 시스템 통합",
            "Интеграция систем непрерывного экологического мониторинга",
          ),
          t(
            "多试剂、多通道、多废液路径的长期在线液路集成",
            "Long-term online fluidic integration for multi-reagent, multi-channel and waste paths",
            "Integración fluídica en línea de larga duración para múltiples reactivos, canales y rutas de residuos",
            "Intégration fluidique en ligne longue durée pour plusieurs réactifs, canaux et voies de déchets",
            "다중 시약·채널·폐액 경로의 장기 온라인 유로 통합",
            "Долговременная онлайн-интеграция трактов реагентов, каналов и отходов",
          ),
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Alimentation, prélèvement, vidange, lavage et surveillance du procédé",
            "공급, 샘플링, 배액, 세척 및 공정 상태 모니터링",
            "Подача, отбор проб, слив, промывка и контроль процесса",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Plataforma automatizada de construcción y cribado",
            "Plateforme automatisée de construction et de criblage",
            "자동 구축 및 스크리닝 플랫폼",
            "Автоматизированная платформа конструирования и скрининга",
          ),
          t(
            ...
            "Construction de souches, distribution de réactifs, pipetage, lavage et criblage à haut débit",
            "균주 구축, 시약 분주, 피펫팅, 세척 및 고처리량 스크리닝",
            "Конструирование штаммов, дозирование реагентов, пипетирование, промывка и высокопроизводительный скрининг",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Sistema de alimentación y control de cultivo",
            "Système d’alimentation et de contrôle de culture",
            "공급 및 배양 제어 시스템",
            "Система подпитки и управления культивированием",
          ),
          t(
            "培养基、诱导剂、缓冲液和添加液稳定补加",
            "Stable feeding of media, inducers, buffers and additives",
            "Alimentación estable de medios, inductores, tampones y aditivos",
            "Alimentation stable en milieux, inducteurs, tampons et additifs",
            "배지, 유도제, 완충액 및 첨가액의 안정적 공급",
            "Стабильная подача сред, индукторов, буферов и добавок",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Muestreo en línea / Análisis de procesos",
            "Prélèvement en ligne / Analyse de procédé",
            "온라인 샘플링 / 공정 분석",
            "Онлайн-отбор проб / Анализ процесса",
          ),
          t(
            "在线取样、样品转移、过滤保护与分析前处理",
            "Online sampling, sample transfer, filtration protection and analytical pretreatment",
            "Muestreo en línea, transferencia, protección por filtración y pretratamiento analítico",
            "Prélèvement en ligne, transfert, protection par filtration et prétraitement analytique",
            "온라인 샘플링, 샘플 이송, 여과 보호 및 분석 전처리",
            "Онлайн-отбор, перенос, фильтрационная защита и аналитическая пробоподготовка",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración de sistemas compactos de bioprocesos",
            "Intégration de systèmes de bioprocédés compacts",
            "소형 바이오프로세스 시스템 통합",
            "Интеграция компактных биопроцессных систем",
          ),
          t(
            "多泵、多阀、多路径液路集成与长期运行维护",
            "Multi-pump, multi-valve and multi-path fluidic integration for long-term operation",
            "Integración fluídica multibomba, multiválvula y multirruta para funcionamiento prolongado",
            "Intégration fluidique multipompe, multivanne et multivoie pour fonctionnement longue durée",
            "다중 펌프·밸브·경로 유로 통합 및 장기 운전 유지보수",
            "Интеграция многопомповых, многоклапанных и многоканальных трактов для длительной работы",
          ),
