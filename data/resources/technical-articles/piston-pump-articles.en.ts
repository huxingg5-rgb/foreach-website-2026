        ...
        parts: [
          {
            ...
            rows: [
              ["Acrylic (PMMA)", "Conventional media and operating conditions with cost sensitivity", "Organic solvents, stress cracking, temperature and long contact"],
              ["PCTG copolyester", "General fluid paths requiring toughness and manufacturability", "Actual formulation, cleaning agents and dimensional stability"],
              ["Polyphenylene sulfide (PPS)", "Higher temperature, stiffness or dimensional-stability requirements", "Compatibility, machining, sealing surfaces and cost"],
              ["Polyvinylidene fluoride (PVDF)", "Selected acids, alkalis and salt solutions", "Chemical concentration, temperature, pressure and seal combination"],
              ["Polypropylene (PP)", "Selected aqueous, acid/alkali or general chemical paths", "Stiffness, temperature, threads, preload and long-term load"],
              ["Polytetrafluoroethylene (PTFE)", "Applications requiring broad chemical resistance", "Creep, stiffness, dimensional stability and feasible geometry"],
              ["Polyether ether ketone (PEEK)", "Higher thermal, mechanical and chemical requirements", "Actual medium, machining, full wetted path and project cost"],
              ["Acetal (POM)", "Structures prioritizing mechanical properties and machining efficiency", "Acids, alkalis, oxidizers, temperature and long exposure"],
              ["Polysulfone (PSU)", "Instrument fluidics requiring stiffness and heat resistance", "Specific chemicals, stress, cleaning process and material grade"],
            ],
          },
        ...
        parts: [
          {
            type: "subsections",
            items: [
              { title: "Acrylic (PMMA) pump heads", paragraphs: ["Polymethyl methacrylate (PMMA), commonly called acrylic, is often the cost-effective starting point for conventional media, moderate temperature and pressure, and projects without special corrosion or heat-resistance requirements. Verify formulations containing solvents, ketones or esters by reviewing composition and testing representative parts."] },
              { title: "PCTG copolyester pump heads", paragraphs: ["PCTG is a copolyester that can balance toughness, machining and general fluidic requirements. Check the actual formulation, cleaning solution, temperature and dimensional change after long exposure."] },
              { title: "Polypropylene (PP) pump heads", paragraphs: ["PP may be evaluated for selected aqueous, acid/alkali and general chemical paths. Head use also requires adequate stiffness, thread loading, seal preload and stability under pressure cycling."] },
              { title: "Acetal (POM) pump heads", paragraphs: ["Polyoxymethylene (POM), commonly called acetal, supports mechanically stable, efficiently machined structures, but acids, alkalis, oxidizing media and long chemical exposure require grade- and condition-specific testing."] },
              { title: "Polyphenylene sulfide (PPS) pump heads", paragraphs: ["PPS can be considered where temperature, stiffness and dimensional stability matter. Evaluate the fluid, cleaning process, structural load, sealing face and material grade together."] },
              { title: "Polyvinylidene fluoride (PVDF) pump heads", paragraphs: ["PVDF may suit selected acid, alkali and salt-solution paths. Suitability still depends on chemical identity, concentration, temperature, pressure, contact time, seals and valves."] },
              { title: "Polytetrafluoroethylene (PTFE) pump heads", paragraphs: ["PTFE has broad chemical resistance, but a pump head must also satisfy stiffness, creep, thread, seal and manufacturing requirements. Chemical resistance alone is not sufficient."] },
              { title: "Polyether ether ketone (PEEK) pump heads", paragraphs: ["PEEK is a candidate for demanding thermal, mechanical, dimensional and chemical conditions. It is not universally compatible; verify the real formulation, temperature, pressure, cleaning method and complete wetted path while considering machining and cost."] },
              { title: "Polysulfone (PSU) pump heads", paragraphs: ["PSU can be evaluated for instrument fluidics requiring stiffness, temperature resistance and dimensional stability. Verify chemicals, stress, cleaning method, grade and long-term exposure."] },
            ],
          },
        ],
      },
        ...
        parts: [
          p("FOREACH EA-500-PMMA and EA-500-PEEK illustrate two head-material directions at the same nominal 500 μL capacity. The displayed configurations support 1/4-28 UNF or M6 ports and 2,000 full-stroke steps. Under specified test conditions, full-stroke accuracy and repeatability are both ≤0.5%."),
          {
            ...
            rows: [
              ...
              ["Displayed head material", "Acrylic (PMMA)", "PEEK"],
