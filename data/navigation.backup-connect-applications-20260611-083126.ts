...
const applicationMegaDropdown: MegaDropdown = {
  ...
  cards: [
...

    {
      ...
      images: [
        applicationSceneImage("/images/applications/mega-menu/life-cell-analysis.webp", t("细胞分析设备", "Cell Analysis Systems", "Sistemas de análisis celular", "Systèmes d’analyse cellulaire", "세포 분석 장비", "Системы клеточного анализа"), t("样本转移、试剂加入、清洗与废液处理", "Sample transfer, reagent addition, washing, and waste handling", "Transferencia, reactivos, lavado y residuos", "Transfert, réactifs, lavage et déchets", "샘플 이송, 시약, 세척 및 폐액", "Перенос, реагенты, промывка и отходы"), localizedPath("/applications/life-science?application=cellCulture")),
        applicationSceneImage("/images/applications/mega-menu/life-protein-analysis.webp", t("蛋白分析设备", "Protein Analysis Systems", "Sistemas de análisis de proteínas", "Systèmes d’analyse des protéines", "단백질 분석 장비", "Системы анализа белков"), t("缓冲液、试剂和样本处理液路", "Buffer, reagent, and sample handling fluidics", "Tampón, reactivos y muestras", "Tampon, réactifs et échantillons", "버퍼, 시약 및 샘플 처리", "Буферы, реагенты и образцы"), localizedPath("/applications/life-science?application=protein")),
        applicationSceneImage("/images/applications/mega-menu/life-nucleic-acid.webp", t("核酸处理设备", "Nucleic Acid Processing", "Procesamiento de ácidos nucleicos", "Traitement des acides nucléiques", "핵산 처리 장비", "Обработка нуклеиновых кислот"), t("裂解、结合、清洗、洗脱与转移液路", "Lysis, binding, washing, elution, and transfer", "Lisis, unión, lavado, elución y transferencia", "Lyse, liaison, lavage, élution et transfert", "용해, 결합, 세척, 용출 및 이송", "Лизис, связывание, промывка, элюирование"), localizedPath("/applications/life-science?application=genomics")),
        applicationSceneImage("/images/applications/mega-menu/life-sample-prep.webp", t("样本前处理设备", "Sample Preparation Systems", "Sistemas de preparación de muestras", "Systèmes de préparation d’échantillons", "샘플 전처리 장비", "Системы пробоподготовки"), t("自动加样、移液、混匀与废液排放", "Automated dispensing, pipetting, mixing, and waste discharge", "Dispensación, pipeteo, mezcla y residuos", "Distribution, pipetage, mélange et déchets", "자동 분주, 피펫팅, 혼합 및 폐액", "Дозирование, пипетирование, смешивание и отходы"), localizedPath("/applications/life-science?application=automation")),
        applicationSceneImage("/images/applications/mega-menu/life-microfluidic-platform.webp", t("微流控实验平台", "Microfluidic Platforms", "Plataformas microfluídicas", "Plateformes microfluidiques", "미세유체 플랫폼", "Микрофлюидные платформы"), t("小体积液体控制、路径切换与模块化连接", "Small-volume control, path switching, and modular connections", "Bajo volumen, conmutación y conexión modular", "Petits volumes, commutation et connexions modulaires", "소량 제어, 경로 전환 및 모듈 연결", "Малые объемы, переключение и соединения"), localizedPath("/applications/life-science?application=bioProcess")),
      ],
      order: 2,
      enabled: true,
    },

    {
      ...
      images: [
        applicationSceneImage("/images/applications/mega-menu/lab-pipetting-workstation.webp", t("自动移液工作站", "Automated Pipetting Workstation", "Estación de pipeteo automatizada", "Station de pipetage automatisée", "자동 피펫팅 워크스테이션", "Автоматическая станция пипетирования"), t("移液、分液、吸头退卸与液位检测", "Pipetting, dispensing, tip ejection, and liquid level detection", "Pipeteo, dispensación, puntas y nivel", "Pipetage, distribution, embouts et niveau", "피펫팅, 분주, 팁 배출 및 액면 감지", "Пипетирование, дозирование, наконечники и уровень"), localizedPath("/applications/lab-automation?application=pipetting")),
        applicationSceneImage("/images/applications/mega-menu/lab-sample-processing.webp", t("自动样本处理系统", "Automated Sample Processing", "Procesamiento automatizado de muestras", "Traitement automatisé d’échantillons", "자동 샘플 처리 시스템", "Автоматическая обработка образцов"), t("样本转移、加液、清洗和废液处理", "Sample transfer, dispensing, washing, and waste handling", "Transferencia, dispensación, lavado y residuos", "Transfert, distribution, lavage et déchets", "샘플 이송, 분주, 세척 및 폐액", "Перенос, дозирование, промывка и отходы"), localizedPath("/applications/lab-automation?application=samplePrep")),
        applicationSceneImage("/images/applications/mega-menu/lab-microplate-processing.webp", t("微孔板处理设备", "Microplate Processing", "Procesamiento de microplacas", "Traitement de microplaques", "마이크로플레이트 처리 장비", "Обработка микропланшетов"), t("洗板、加液、吸液和残液控制", "Plate washing, dispensing, aspiration, and residual control", "Lavado, dispensación, aspiración y residuos", "Lavage, distribution, aspiration et résidus", "플레이트 세척, 분주, 흡입 및 잔액", "Промывка, дозирование, аспирация и остатки"), localizedPath("/applications/lab-automation?application=microplate")),
        applicationSceneImage("/images/applications/mega-menu/lab-integrated-system.webp", t("联机自动化系统", "Integrated Automation Systems", "Sistemas automatizados integrados", "Systèmes automatisés intégrés", "통합 자동화 시스템", "Интегрированные системы"), t("多模块液路连接、路径切换和状态监测", "Multi-module fluid connections, switching, and monitoring", "Conexiones, conmutación y monitoreo", "Connexions, commutation et surveillance", "다중 모듈 연결, 전환 및 모니터링", "Модульные соединения, переключение и контроль"), localizedPath("/applications/lab-automation?application=systemIntegration")),
        applicationSceneImage("/images/applications/mega-menu/lab-reagent-dispensing.webp", t("试剂分配平台", "Reagent Dispensing Platforms", "Plataformas de dispensación de reactivos", "Plateformes de distribution de réactifs", "시약 분주 플랫폼", "Платформы дозирования реагентов"), t("多试剂定量分配、通道切换与长期稳定输送", "Multi-reagent metering, channel switching, and stable transfer", "Рeactivos, canales y transferencia estable", "Réactifs, canaux et transfert stable", "다중 시약 계량, 채널 전환 및 안정 이송", "Дозирование, каналы и стабильная подача"), localizedPath("/applications/lab-automation?application=reagentDispensing")),
      ],
      order: 3,
      enabled: true,
    },

    {
      ...
      images: [
        applicationSceneImage("/images/applications/mega-menu/analytical-chromatography.webp", t("色谱系统", "Chromatography Systems", "Sistemas de cromatografía", "Systèmes de chromatographie", "크로마토그래피 시스템", "Хроматографические системы"), t("溶剂输送、阀切换与高可靠管路连接", "Solvent delivery, valve switching, and reliable connections", "Solventes, válvulas y conexiones fiables", "Solvants, vannes et raccordements fiables", "용매 이송, 밸브 전환 및 연결", "Растворители, клапаны и соединения")),
        applicationSceneImage("/images/applications/mega-menu/analytical-ms-pretreatment.webp", t("质谱前处理", "MS Pretreatment", "Pretratamiento MS", "Prétraitement MS", "질량분석 전처리", "Пробоподготовка для МС"), t("样本转移、清洗、废液排放与防污染控制", "Sample transfer, washing, waste discharge, and contamination control", "Transferencia, lavado, residuos y contaminación", "Transfert, lavage, déchets et contamination", "샘플 이송, 세척, 폐액 및 오염 제어", "Перенос, промывка, отходы и загрязнение")),
        applicationSceneImage("/images/applications/mega-menu/analytical-spectroscopy.webp", t("光谱分析仪器", "Spectroscopy Instruments", "Instrumentos de espectroscopía", "Instruments de spectroscopie", "분광 분석 장비", "Спектроскопические приборы"), t("试剂加入、样本池清洗和流路切换", "Reagent addition, sample cell washing, and flow switching", "Reactivos, celda y conmutación", "Réactifs, cellule et commutation", "시약 첨가, 셀 세척 및 유로 전환", "Реагенты, ячейка и переключение")),
        applicationSceneImage("/images/applications/mega-menu/analytical-online-system.webp", t("在线分析系统", "Online Analysis Systems", "Sistemas de análisis en línea", "Systèmes d’analyse en ligne", "온라인 분석 시스템", "Онлайн-анализаторы"), t("连续采样、过滤、试剂加入和状态监测", "Continuous sampling, filtration, reagent addition, and monitoring", "Muestreo, filtración, reactivos y monitoreo", "Échantillonnage, filtration, réactifs et surveillance", "연속 샘플링, 여과, 시약 및 모니터링", "Отбор, фильтрация, реагенты и контроль")),
        applicationSceneImage("/images/applications/mega-menu/analytical-titration.webp", t("滴定 / 电化学分析设备", "Titration / Electrochemical Analysis", "Titulación / análisis electroquímico", "Titrage / analyse électrochimique", "적정 / 전기화학 분석 장비", "Титрование / электрохимический анализ"), t("精密加液、定量分配与管路密封连接", "Precision dispensing, metering, and sealed connections", "Dispensación precisa, dosificación y sellado", "Distribution précise, dosage et étanchéité", "정밀 분주, 계량 및 밀봉 연결", "Точное дозирование и герметичные соединения")),
      ],
      order: 4,
      enabled: true,
    },

    {
      ...
      images: [
        applicationSceneImage("/images/applications/mega-menu/environment-water-monitoring.webp", t("水质在线监测", "Water Quality Monitoring", "Monitoreo de calidad del agua", "Surveillance de la qualité de l’eau", "수질 온라인 모니터링", "Контроль качества воды"), t("采样、试剂加入、清洗和废液排放", "Sampling, reagent addition, washing, and waste discharge", "Muestreo, reactivos, lavado y residuos", "Prélèvement, réactifs, lavage et déchets", "샘플링, 시약, 세척 및 폐액", "Отбор, реагенты, промывка и отходы")),
        applicationSceneImage("/images/applications/mega-menu/environment-gas-analysis.webp", t("气体分析设备", "Gas Analysis Systems", "Sistemas de análisis de gases", "Systèmes d’analyse de gaz", "가스 분석 장비", "Газоанализаторы"), t("采样、切换、过滤和状态监测", "Sampling, switching, filtration, and monitoring", "Muestreo, conmutación, filtración y monitoreo", "Prélèvement, commutation, filtration et surveillance", "샘플링, 전환, 여과 및 모니터링", "Отбор, переключение, фильтрация и контроль")),
        applicationSceneImage("/images/applications/mega-menu/environment-pretreatment.webp", t("在线预处理系统", "Online Pretreatment Systems", "Sistemas de pretratamiento en línea", "Systèmes de prétraitement en ligne", "온라인 전처리 시스템", "Системы онлайн-подготовки"), t("过滤、清洗、防堵和流路保护", "Filtration, washing, anti-clogging, and flow path protection", "Filtración, lavado, antiobstrucción y protección", "Filtration, lavage, anti-colmatage et protection", "여과, 세척, 막힘 방지 및 유로 보호", "Фильтрация, промывка, защита от засоров")),
        applicationSceneImage("/images/applications/mega-menu/environment-portable-device.webp", t("便携式检测设备", "Portable Testing Devices", "Dispositivos portátiles de prueba", "Appareils de test portables", "휴대용 검출 장비", "Портативные приборы"), t("小型泵阀、管路连接和低功耗控制", "Compact pumps, valves, tubing connections, and low-power control", "Bombas, válvulas, conexiones y bajo consumo", "Pompes, vannes, raccordements et basse consommation", "소형 펌프, 밸브, 연결 및 저전력 제어", "Компактные насосы, клапаны, соединения и низкое энергопотребление")),
        applicationSceneImage("/images/applications/mega-menu/environment-auto-sampling.webp", t("自动采样系统", "Automatic Sampling Systems", "Sistemas de muestreo automático", "Systèmes d’échantillonnage automatique", "자동 샘플링 시스템", "Автоматические системы отбора"), t("定量采样、路径切换与液路状态识别", "Quantitative sampling, path switching, and fluid status recognition", "Muestreo cuantitativo, conmutación y estado", "Prélèvement quantitatif, commutation et état", "정량 샘플링, 경로 전환 및 상태 인식", "Дозированный отбор, переключение и контроль состояния")),
      ],
      order: 5,
      enabled: true,
    },

    {
      ...
      href: anchorPath("applications"),
      images: [
        applicationSceneImage("/images/applications/mega-menu/synthetic-bioreactor.webp", t("生物反应器", "Bioreactors", "Biorreactores", "Bioréacteurs", "생물반응기", "Биореакторы"), t("培养液添加、补液、取样和废液处理", "Media addition, feeding, sampling, and waste handling", "Medio, alimentación, muestreo y residuos", "Milieu, alimentation, prélèvement et déchets", "배지 첨가, 보충, 샘플링 및 폐액", "Среда, подпитка, отбор и отходы")),
        applicationSceneImage("/images/applications/mega-menu/synthetic-continuous-flow.webp", t("连续流系统", "Continuous Flow Systems", "Sistemas de flujo continuo", "Systèmes à flux continu", "연속 흐름 시스템", "Системы непрерывного потока"), t("稳定输送、路径切换和状态监测", "Stable delivery, path switching, and status monitoring", "Transferencia estable, conmutación y monitoreo", "Transfert stable, commutation et surveillance", "안정 이송, 경로 전환 및 상태 모니터링", "Стабильная подача, переключение и контроль")),
        applicationSceneImage("/images/applications/mega-menu/synthetic-auto-culture.webp", t("自动培养系统", "Automated Culture Systems", "Sistemas de cultivo automatizado", "Systèmes de culture automatisés", "자동 배양 시스템", "Автоматические системы культивирования"), t("加液、换液、取样和废液排放", "Dispensing, media exchange, sampling, and waste discharge", "Dispensación, cambio de medio, muestreo y residuos", "Distribution, renouvellement, prélèvement et déchets", "분주, 배지 교환, 샘플링 및 폐액", "Дозирование, замена среды, отбор и отходы")),
        applicationSceneImage("/images/applications/mega-menu/synthetic-microfluidic-platform.webp", t("微流控实验平台", "Microfluidic Platforms", "Plataformas microfluídicas", "Plateformes microfluidiques", "미세유체 플랫폼", "Микрофлюидные платформы"), t("小体积液体控制和模块化连接", "Small-volume fluid control and modular connections", "Control de bajo volumen y conexiones modulares", "Contrôle de petits volumes et connexions modulaires", "소량 유체 제어 및 모듈 연결", "Управление малыми объемами и модульные соединения")),
        applicationSceneImage("/images/applications/mega-menu/synthetic-high-throughput.webp", t("高通量筛选设备", "High-throughput Screening", "Cribado de alto rendimiento", "Criblage haut débit", "고처리량 스크리닝 장비", "Высокопроизводительный скрининг"), t("多通道加样、试剂分配和反应液转移", "Multi-channel dispensing, reagent delivery, and reaction transfer", "Canales múltiples, reactivos y transferencia", "Canaux multiples, réactifs et transfert", "다중 채널 분주, 시약 및 반응액 이송", "Многоканальное дозирование, реагенты и перенос")),
      ],
      order: 6,
      enabled: true,
    },
