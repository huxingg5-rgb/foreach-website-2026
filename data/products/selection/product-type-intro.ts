...
export const productTypeIntroMap: Record<string, ProductTypeIntroContent> = {
  ...
  "pumps:diaphragm-pump": {
    ...
    paragraphs: [
      ...
      "微型隔膜泵也常根据应用被称为微型液泵。液泵选型应考虑工作流量、压力、自吸条件、管路阻力、[接液材质兼容性](/resources/technical-articles/micro-diaphragm-pump-materials-selection/)、[电机类型与寿命](/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/)以及[调速与控制方式](/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/)；当空气可能随液体一起或间歇进入管路时，应选择气液混合隔膜泵，并评估真空度、抽空时间和系统容积。",
  ...
  "pumps:diaphragm-pump": {
    en: {
      ...
      paragraphs: [
        ...
        "Miniature diaphragm pumps are also commonly searched as micro diaphragm pumps or micro liquid pumps, depending on the application. Liquid-pump selection should consider working flow, pressure, self-priming conditions, tubing resistance, [wetted-material compatibility](/en/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [motor type and service life](/en/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), and [speed control and control interfaces](/en/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/). For systems where air may enter the tubing together with liquid, use a gas-liquid diaphragm pump and evaluate vacuum level, evacuation time, and system volume.",
    ...
    ko: {
      ...
      paragraphs: [
        ...
        "용도에 따라 마이크로 다이어프램 펌프 또는 마이크로 액체 펌프로도 검색됩니다. 액체 펌프는 작동 유량, 압력, 자흡 조건, 튜빙 저항, [접액부 재질 호환성](/ko/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [모터 유형과 수명](/ko/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/) 및 [속도 조절과 제어 방식](/ko/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/)을 고려해 선정해야 합니다. 액체와 함께 공기가 유입될 수 있는 시스템에는 기액 혼합 펌프를 사용하고 진공도, 배기 시간 및 시스템 용적을 평가하십시오.",
    ...
    ru: {
      ...
      paragraphs: [
        ...
        "В зависимости от применения такие изделия также ищут как микромембранные насосы или микронасосы для жидкостей. При выборе жидкостного насоса учитывайте рабочий расход, давление, условия самовсасывания, сопротивление трубок, [совместимость контактирующих материалов](/ru/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [тип и ресурс двигателя](/ru/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), а также [регулирование скорости и интерфейсы управления](/ru/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/). Если вместе с жидкостью в трубку может попадать воздух, используйте газожидкостный насос и оценивайте вакуум, время откачки и объём системы.",
  ...
  liquid: {
    zh: {
      ...
      paragraphs: [
        ...
        `按所需出口压力选择：[0–100 kPa](filter:filter04=100%20kPa)时，根据所需工作流量选择DPL30或DPL60；[超过100 kPa、最高600 kPa](filter:filter04=600%20kPa)时，评估DPL30H。以上流量为自由流量，实际工作点取决于泵曲线和系统阻力，并会随背压、吸入条件、管路阻力和流体性质变化。 还需确认[接液材质兼容性](/resources/technical-articles/micro-diaphragm-pump-materials-selection/)、[电机类型与寿命](/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/)、[调速与控制方式](/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/)。`,
        ...
        `装机验证还可按[自吸选型与启动时间](/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/)、[流量脉动测量与降低措施](/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/)、[噪声原因与减振降噪](/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/)和[停机回流与防虹吸设计](/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/)逐项确认。`,
      ],
      image: {
    ...
    en: {
      ...
      paragraphs: [
        ...
        `Select by required outlet pressure: for [0–100 kPa](filter:filter04=100%20kPa), choose DPL30 or DPL60 according to the required working flow. For pressures [above 100 kPa and up to 600 kPa](filter:filter04=600%20kPa), evaluate DPL30H. The flow values above are free-flow values; the actual operating point depends on the pump curve and system resistance and varies with backpressure, suction conditions, tubing resistance, and fluid properties. Also confirm [wetted-material compatibility](/en/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [motor type and service life](/en/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), [speed control and control interfaces](/en/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/).`,
        ...
        `For installation validation, also check [Self-priming and start-up time](/en/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/), [Measuring and reducing flow pulsation](/en/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/), [Noise and vibration reduction](/en/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/) and [Stopped backflow and anti-siphon design](/en/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/).`,
      ],
      image: {
        src: "/images/resources/technical-articles/dpl60-liquid-diaphragm-pump/dpl60-article-cover.webp",
    ...
    es: {
      ...
      paragraphs: [
        ...
        `Seleccione según la presión de salida requerida: para [0–100 kPa](filter:filter04=100%20kPa), elija DPL30 o DPL60 según el caudal de trabajo necesario. Para presiones [superiores a 100 kPa y de hasta 600 kPa](filter:filter04=600%20kPa), evalúe DPL30H. Los valores de caudal anteriores corresponden al caudal libre; el punto de funcionamiento real depende de la curva de la bomba y de la resistencia del sistema, y varía con la contrapresión, las condiciones de aspiración, la resistencia de los tubos y las propiedades del fluido. Confirme también [la compatibilidad de los materiales en contacto con el fluido](/es/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [el tipo y la vida útil del motor](/es/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), [la regulación de velocidad y las interfaces de control](/es/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/).`,
        ...
        `En la validación del montaje, compruebe también [Autocebado y tiempo de arranque](/es/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/), [Medición y reducción de pulsaciones](/es/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/), [Reducción de ruido y vibraciones](/es/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/) y [Retorno al parar y diseño antisifón](/es/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/).`,
      ],
      image: {
        src: "/images/resources/technical-articles/dpl60-liquid-diaphragm-pump/dpl60-article-cover.webp",
    ...
    fr: {
      ...
      paragraphs: [
        ...
        `Sélectionnez selon la pression de sortie requise : [de 0 à 100 kPa](filter:filter04=100%20kPa), choisissez DPL30 ou DPL60 selon le débit de travail nécessaire. Pour une pression [supérieure à 100 kPa et jusqu’à 600 kPa](filter:filter04=600%20kPa), évaluez DPL30H. Les valeurs de débit ci-dessus correspondent au débit libre ; le point de fonctionnement réel dépend de la courbe de la pompe et de la résistance du système, et varie avec la contre-pression, les conditions d’aspiration, la résistance des tuyaux et les propriétés du fluide. Vérifiez également [la compatibilité des matériaux en contact avec le fluide](/fr/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [type et de la durée de vie du moteur](/fr/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), [modes de réglage de vitesse et de commande](/fr/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/).`,
        ...
        `Pour valider l’intégration, vérifiez aussi [Auto-amorçage et temps de démarrage](/fr/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/), [Mesure et réduction des pulsations](/fr/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/), [Réduction du bruit et des vibrations](/fr/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/) et [Retour à l’arrêt et conception anti-siphon](/fr/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/).`,
      ],
      image: {
        src: "/images/resources/technical-articles/dpl60-liquid-diaphragm-pump/dpl60-article-cover.webp",
    ...
    ko: {
      ...
      paragraphs: [
        ...
        `필요한 토출 압력에 따라 선택하십시오. [0–100 kPa](filter:filter04=100%20kPa)에서는 필요한 작동 유량에 따라 DPL30 또는 DPL60을 선택합니다. [100 kPa 초과 600 kPa 이하](filter:filter04=600%20kPa)에서는 DPL30H를 평가하십시오. 위 유량 값은 자유 유량이며, 실제 작동점은 펌프 곡선과 시스템 저항에 따라 결정되고 배압, 흡입 조건, 튜빙 저항 및 유체 특성에 따라 달라집니다. 다음 항목도 확인하십시오: [접액부 재질 호환성](/ko/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [모터 유형과 수명](/ko/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), [속도 조절과 제어 방식](/ko/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/).`,
        ...
        `장착 검증 시 [자흡 선정과 기동 시간](/ko/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/), [유량 맥동 측정과 저감](/ko/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/), [소음과 진동 저감](/ko/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/), [정지 후 역류와 사이펀 방지](/ko/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/)도 확인하십시오.`,
      ],
      image: {
        src: "/images/resources/technical-articles/dpl60-liquid-diaphragm-pump/dpl60-article-cover.webp",
    ...
    ru: {
      ...
      paragraphs: [
        ...
        `Выбирайте насос по требуемому давлению на выходе: при [0–100 kPa](filter:filter04=100%20kPa) выбирайте DPL30 или DPL60 в соответствии с требуемым рабочим расходом. При давлении [свыше 100 kPa и до 600 kPa](filter:filter04=600%20kPa) оцените DPL30H. Приведенные выше значения расхода являются значениями свободного расхода; фактическая рабочая точка зависит от характеристики насоса и сопротивления системы и изменяется в зависимости от противодавления, условий всасывания, сопротивления трубок и свойств жидкости. Также проверьте [совместимость контактирующих материалов](/ru/resources/technical-articles/micro-diaphragm-pump-materials-selection/), [тип и ресурс двигателя](/ru/resources/technical-articles/brushed-vs-brushless-diaphragm-pump-3000h-10000h/), [регулирование скорости и интерфейсы управления](/ru/resources/technical-articles/brushless-diaphragm-pump-2-wire-vs-5-wire/).`,
        ...
        `При проверке монтажа также оцените [Самовсасывание и время запуска](/ru/resources/technical-articles/self-priming-miniature-liquid-diaphragm-pump-selection/), [Измерение и снижение пульсаций](/ru/resources/technical-articles/miniature-diaphragm-pump-flow-pulsation-reduction/), [Снижение шума и вибрации](/ru/resources/technical-articles/miniature-diaphragm-pump-noise-vibration-reduction/) и [Обратный поток и защита от сифона](/ru/resources/technical-articles/miniature-diaphragm-pump-backflow-check-valve/).`,
      ],
      image: {
        src: "/images/resources/technical-articles/dpl60-liquid-diaphragm-pump/dpl60-article-cover.webp",
