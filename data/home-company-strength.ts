  ...
  honors: [
    {
      ...
      title: {
        ...
        fr: "Système de management de la qualité",
        ko: "품질 관리 시스템",
    ...
    },
    {
      ...
      title: {
        "zh-CN": "产品测试验证",
        en: "Product Testing & Validation",
        es: "Pruebas y validación de productos",
        fr: "Tests et validation des produits",
        ko: "제품 테스트 및 검증",
        ru: "Тестирование и валидация продукции",
      },
    },
    {
      key: "qualification",
      title: {
        "zh-CN": "企业资质认证",
        en: "Company Qualifications",
        es: "Certificaciones de la empresa",
        fr: "Qualifications de l’entreprise",
        ko: "기업 인증",
        ru: "Квалификации компании",
      },
    },
    {
      key: "supply-chain",
      title: {
        ...
        es: "Colaboración en cadena de suministro",
        fr: "Collaboration de la chaîne d’approvisionnement",
        ko: "공급망 협업",
        ru: "Координация цепочки поставок",
      },
    },
    {
      ...
      title: {
        "zh-CN": "项目交付经验",
        en: "Project Delivery Experience",
        es: "Experiencia en entrega de proyectos",
        fr: "Expérience en livraison de projets",
        ko: "프로젝트 납품 경험",
        ru: "Опыт реализации проектов",
      },
    },
