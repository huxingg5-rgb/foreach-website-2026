...
function buildDrplDetail(base, config) {
  ...
  item.specs = [
    ...
    spec("试剂A 工作液路接口", "1/4-28 UNF-2B"),
    spec("试剂B 工作液路接口", "G1/8（默认带金属快插接头）"),
    spec("试剂A 清洗液路接口", "1/4-28 UNF-2B"),
    spec("试剂B 清洗液路接口", "1/4-28 UNF-2B"),
    spec("试剂A 端耐压", "Max 150 kPa"),
    spec("试剂B 端耐压", "Max 150 kPa"),
    spec("尺寸/mm", "180 × 83.7 × 75 mm"),
    spec("重量", "1536 g"),
    spec("准确性", "<2%"),
    spec("重复性", "<0.5%"),
  ...
  item.productTypeName = "DRPL 双头无阀泵";
...
const expected = {
  ...
  "drpl-0109": {
    ...
    specs: {
      ...
      "流量 QMin，mL/min": "60",
      "流量 QMax，mL/min": "300",
      "试剂A 工作液路接口": "1/4-28 UNF-2B",
      "试剂B 工作液路接口": "G1/8（默认带金属快插接头）",
      "试剂A 清洗液路接口": "1/4-28 UNF-2B",
      "试剂B 清洗液路接口": "1/4-28 UNF-2B",
      "试剂A 端耐压": "Max 150 kPa",
      "试剂B 端耐压": "Max 150 kPa",
      "尺寸/mm": "180 × 83.7 × 75 mm",
      "重量": "1536 g",
      "准确性": "<2%",
      "重复性": "<0.5%",
      "寿命": "20,000,000 cycles",
