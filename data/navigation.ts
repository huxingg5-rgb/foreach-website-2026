...
import { translateRussianNavigationText } from "./applications/application-russian";
...
function t(
  ...
  return {
    ...
    fr,
    ko,
    ru: ru === en ? translateRussianNavigationText(zhCN) : ru,
  };
}
  ...
  cards: [
    {
      ...
      description: t(
        ...
        "Pour l’aspiration d’échantillons, distribution de réactifs, lavage, déchets, commutation, raccordements et surveillance dans les instruments IVD.",
...

    {
      ...
      description: t(
        ...
        "Pour le traitement d’échantillons, réactifs, réaction, séparation et prétraitement.",
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Génomique / préparation d’échantillons",
            "Genomics / Sample Preparation",
            "Genomics / Sample Preparation",
          ),
          t(
            ...
            "Circuitos de lisis, unión, lavado, elución y bajo residuo",
            "circuits de lyse, liaison, lavage, élution et faible résidu",
            "Lysis, binding, washing, elution and low-residue fluidic paths",
            "Lysis, binding, washing, elution and low-residue fluidic paths",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "alimentation en milieu, commutation de tampons et transfert en circuit fermé",
            "Media replenishment, buffer switching and closed fluid transfer",
            "Media replenishment, buffer switching and closed fluid transfer",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Estación automatizada de laboratorio",
            "station automatisée de laboratoire",
            "Laboratory Automation Workstation",
            "Laboratory Automation Workstation",
          ),
          t(
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "analyse de protéines / anticorps",
            "Protein / Antibody Analysis",
            "Protein / Antibody Analysis",
          ),
          t(
            ...
            "injection des échantillons, commutation de tampons et circuits de faible adsorption",
            "Sample injection, buffer switching and low-adsorption flow paths",
            "Sample injection, buffer switching and low-adsorption flow paths",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "alimentation, prélèvement, vidange et surveillance du processus",
            "Feeding, sampling, drainage and process status monitoring",
            "Feeding, sampling, drainage and process status monitoring",
          ),
...

    {
      ...
      description: t(
        ...
        "Pour le pipetage, transfert, microplaques, lavage, déchets et fluidique intégrée.",
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "station de préparation d’échantillons",
            "Sample Preparation Workstation",
            "Sample Preparation Workstation",
          ),
          t(
            ...
            "Preparación de muestras, dosificación de reactivos, lavado, elución y evacuación",
            "préparation d’échantillons, dosage de réactifs, lavage, élution et évacuation",
            "Sample pretreatment, reagent dosing, washing, elution and waste drainage",
            "Sample pretreatment, reagent dosing, washing, elution and waste drainage",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Plataforma de pipeteo automatizado",
            "plateforme de pipetage automatisé",
            "Automated Pipetting Platform",
            "Automated Pipetting Platform",
          ),
          t(
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Equipos de procesamiento de microplacas",
            "équipements de traitement de microplaques",
            "Microplate Processing Systems",
            "Microplate Processing Systems",
          ),
          t(
            ...
            "Dispensación en placas, lavado, aspiración de residuos y gestión de desechos",
            "distribution dans plaques, lavage, aspiration de résidus et gestion de déchets",
            "Plate dosing, washing, residual liquid aspiration and waste handling",
            "Plate dosing, washing, residual liquid aspiration and waste handling",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Equipos de dispensación de reactivos",
            "équipements de distribution de réactifs",
            "Reagent Dispensing Systems",
            "Reagent Dispensing Systems",
          ),
          t(
            ...
            "Dosificación repetida de tampones, soluciones de lavado, medios y aditivos",
            "dosage répété de tampons, solutions de lavage, milieux et additifs",
            "Repeatable dosing of buffers, wash solutions, media and additives",
            "Repeatable dosing of buffers, wash solutions, media and additives",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración fluídica multimódulo, multipuesto y multivía con monitorización",
            "intégration fluidique multimodule, multiposte et multivoie avec surveillance",
            "Multi-module, multi-station and multi-path fluidic integration with status monitoring",
            "Multi-module, multi-station and multi-path fluidic integration with status monitoring",
          ),
...

    {
      ...
      description: t(
        ...
        "Pour les réactifs, échantillonnage continu, commutation, lavage et raccordements précis.",
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "Introducción de muestras, conmutación de disolventes, lavado, evacuación y bajo residuo",
            "injection des échantillons, commutation de solvants, lavage, évacuation et faible résidu",
            "Sample injection, solvent switching, washing, waste drainage and low-residue flow paths",
            "Sample injection, solvent switching, washing, waste drainage and low-residue flow paths",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Espectroscopía / Análisis elemental",
          ...
          t(
            ...
            "Suministro de muestras, dosificación de reactivos, lavado y evacuación",
            "alimentation d’échantillons, dosage de réactifs, lavage et évacuation",
            "Sample delivery, reagent dosing, washing and waste drainage",
            "Sample delivery, reagent dosing, washing and waste drainage",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Calidad del agua / Monitoreo ambiental",
          ...
          t(
            ...
            "Muestreo, dosificación de reactivos, reacción, lavado y evacuación",
            "prélèvement, dosage de réactifs, réaction, lavage et évacuation",
            "Sampling, reagent dosing, reaction detection, washing and waste drainage",
            "Sampling, reagent dosing, reaction detection, washing and waste drainage",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "dilution, extraction, mélange, filtration et maîtrise de plusieurs circuits",
            "Dilution, extraction, mixing, filtration and multi-path fluidic control",
            "Dilution, extraction, mixing, filtration and multi-path fluidic control",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración de sistemas analíticos de laboratorio",
            "intégration de systèmes analytiques de laboratoire",
            "Laboratory Analyzer System Integration",
            "Laboratory Analyzer System Integration",
          ),
          t(
            ...
            "intégration fluidique de plusieurs modules, réactifs et circuits de détection",
            "Fluidic system integration for multi-module, multi-reagent and multi-detection paths",
            "Fluidic system integration for multi-module, multi-reagent and multi-detection paths",
          ),
...

    {
      ...
      description: t(
        ...
        "Pour le prélèvement d’eau, réactifs, prétraitement, lavage, déchets et surveillance.",
      ...
      images: [
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Muestreo de agua compleja, filtración, reacción y mantenimiento del drenaje",
            "prélèvement d’eau complexe, filtration, réaction et maintenance de la vidange",
            "Complex water sampling, filtration protection, reagent reaction and drainage maintenance",
            "Complex water sampling, filtration protection, reagent reaction and drainage maintenance",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Emisiones / Pretratamiento de gases",
            "émissions / prétraitement de gaz",
            "Flue Gas / Gas Pretreatment",
            "Flue Gas / Gas Pretreatment",
          ),
          t(
            ...
            "vidange de condensat, alimentation de solution absorbante, lavage et prévention d’obstructions",
            "Condensate drainage, absorbent delivery, washing and anti-clogging protection",
            "Condensate drainage, absorbent delivery, washing and anti-clogging protection",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Muestreo ambiental y pretratamiento",
            "prélèvement environnemental et prétraitement",
            "Environmental Sampling & Pretreatment",
            "Environmental Sampling & Pretreatment",
          ),
          t(
            ...
            "transfert, dilution, filtration, mélange et évacuation d’échantillons",
            "Sample transfer, dilution, filtration, mixing and waste drainage",
            "Sample transfer, dilution, filtration, mixing and waste drainage",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración fluídica continua de múltiples reactivos, canales y residuos",
            "intégration fluidique continue de plusieurs réactifs, canaux et résidus",
            "Long-term online fluidic integration for multi-reagent, multi-channel and waste paths",
            "Long-term online fluidic integration for multi-reagent, multi-channel and waste paths",
          ),
...

    {
      ...
      description: t(
        ...
        "Pour la culture, alimentation, prélèvement, renouvellement, flux continu et procédé.",
      ...
      images: [
        applicationSceneImage(
          ...
          t(
            ...
            "alimentation, prélèvement, vidange, lavage et surveillance du processus",
            "Feeding, sampling, drainage, washing and process status monitoring",
            "Feeding, sampling, drainage, washing and process status monitoring",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "plateforme automatisée de construction et criblage",
            "Automated Build & Screening Platform",
            "Automated Build & Screening Platform",
          ),
          t(
            ...
            "construction de souches, distribution de réactifs, pipetage, lavage et criblage de haut débit",
            "Strain construction, reagent dispensing, pipetting, washing and high-throughput screening",
            "Strain construction, reagent dispensing, pipetting, washing and high-throughput screening",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "système d’alimentation et maîtrise de culture",
            "Feeding & Culture Control System",
            "Feeding & Culture Control System",
          ),
          t(
            ...
            "alimentation stable de milieux, inducteurs, tampons et additifs",
            "Stable feeding of media, inducers, buffers and additives",
            "Stable feeding of media, inducers, buffers and additives",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "prélèvement en ligne / analyse de processus",
            "Online Sampling / Process Analysis",
            "Online Sampling / Process Analysis",
          ),
          t(
            ...
            "prélèvement en ligne, transfert d’échantillons, filtration et préparation pour l’analyse",
            "Online sampling, sample transfer, filtration protection and analytical pretreatment",
            "Online sampling, sample transfer, filtration protection and analytical pretreatment",
          ),
        ...
        applicationSceneImage(
          ...
          t(
            ...
            "Integración de bioprocesos compactos",
            "intégration de bioprocédés compacts",
            "Compact Bioprocess System Integration",
            "Compact Bioprocess System Integration",
          ),
          t(
            ...
            "intégration de plusieurs pompes, vannes et circuits pour un fonctionnement prolongé",
            "Multi-pump, multi-valve and multi-path fluidic integration for long-term operation",
            "Multi-pump, multi-valve and multi-path fluidic integration for long-term operation",
          ),
