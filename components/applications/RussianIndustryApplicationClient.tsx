...
type RussianIndustryApplication = {
  key: string;
  index: string;
  title: string;
  summary: string;
  ...
  focusSummary: string;
  focusPoints: string[];
  modules: RussianIndustryModule[];
};

export type RussianIndustryApplicationData = {
  ...
  productHref: string;
  contactHref: string;
  products: Record<string, RussianIndustryProduct>;
  applications: RussianIndustryApplication[];
};

type RussianIndustryApplicationClientProps = {
  data: RussianIndustryApplicationData;
...
export default function RussianIndustryApplicationClient({
  data,
  pageClassName,
  applicationTabsAria,
}: RussianIndustryApplicationClientProps) {
  ...
  function handleApplicationChange(application: RussianIndustryApplication) {
  ...
  function handleModuleChange(module: RussianIndustryModule) {
        ...
        <div className="ivd-section-inner">
          ...
          <div className="ivd-ability-layout ivd-ability-layout-top">
            <nav
              ...
              aria-label="Навигация по жидкостным модулям"
            >
                    ...
                    >
                      ...
                      <div className="ivd-product-detail">
                        <p className="ivd-detail-head">
                          <b>Ключевая возможность:</b> {product.ability}
                        </p>
