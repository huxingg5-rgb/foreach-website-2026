...
const ACTUAL_SPECIFICATION_VALUE_TRANSLATIONS: Record<string, string> = {
  "倒刺接口 + 卡箍 / 锁紧结构": "Barbed Connection with Clamp/Locking Structure",
  "\u5341\u5b57\u578b": "Cross-Shaped",
...
const SOURCE_ALIGNED_NARRATIVE_TRANSLATIONS: Record<string, string> = {
  "DPL30H 液体隔膜泵面向较高出口压力的仪器液路，额定压力为 600 kPa，空载流量为 300 mL/min，适用于试剂转移、加压供液、较长管路输送和阻力较高的液路模块。\n\nDPL30H 系列提供有刷与无刷电机以及 12 V / 24 V DC 选项。实际产品采用倒刺接口，并通过卡箍 / 锁紧结构固定软管。": "The DPL30H liquid diaphragm pump is designed for instrument fluid paths requiring higher outlet pressure. Its rated pressure is 600 kPa and its no-load flow is 300 mL/min. It is suited to reagent transfer, pressurized fluid supply, longer fluid paths, and higher-resistance fluidic modules.\n\nThe DPL30H series is available with brushed or brushless motors and 12 V / 24 V DC options. The physical product uses a hose barb secured with a clamp/locking structure.",
