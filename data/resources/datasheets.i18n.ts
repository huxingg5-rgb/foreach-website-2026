...
> = {
  es: {
    ...
    "rpl-p635-p15-valveless-pump": { title: "Ficha técnica de las bombas dosificadoras sin válvulas RPL-P6.35 / RPL-P15", description: "Ficha conjunta RPL-P6.35 / RPL-P15, versión 001 (2025-07): volumen por vuelta, materiales en contacto, conexiones, montaje y accionamiento." },
  ...
  fr: {
    ...
    "rpl-p635-p15-valveless-pump": { title: "Fiche technique des pompes doseuses sans valve RPL-P6.35 / RPL-P15", description: "Fiche commune RPL-P6.35 / RPL-P15, version 001 (2025-07) : volume par tour, matériaux en contact, raccords, montage et entraînement." },
  ...
  ru: {
    ...
    "rpl-p635-p15-valveless-pump": { title: "Техническое описание бесклапанных дозирующих насосов RPL-P6.35 / RPL-P15", description: "Общий документ RPL-P6.35 / RPL-P15, версия 001 (2025-07): объём за оборот, контактные материалы, порты, монтаж и привод." },
  ...
  ko: {
    ...
    "rpl-p635-p15-valveless-pump": { title: "RPL-P6.35 / RPL-P15 무밸브 정량 펌프 데이터시트", description: "RPL-P6.35 / RPL-P15 통합 데이터시트, 버전 001 (2025-07). 회전당 토출량, 접액 재질, 포트, 설치 및 구동 구성을 안내합니다." },
