  ...
  columns: [
    {
      ...
      links: [
        { key: "pumps", label: { china: "泵系列", global: "Pump Series" }, href: href("/products?category=pumps") },
        { key: "valves", label: { china: "阀系列", global: "Valve Series" }, href: href("/products?category=valves") },
        { key: "probes", label: { china: "针系列", global: "Probe Series" }, href: href("/products?category=probes") },
        { key: "fittings", label: { china: "接头系列", global: "Fitting Series" }, href: href("/products?category=fittings") },
        { key: "tubing", label: { china: "管路系列", global: "Tubing Series" }, href: href("/products?category=tubing") },
