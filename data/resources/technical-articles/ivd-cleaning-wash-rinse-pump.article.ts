...
export const ivdCleaningWashRinsePumpCopies = {
  ...
  ko: {
    ...
    sections: [
      ...
      { title: "11. IVD 유로 작업별 펌프 유형", blocks: [{ type: "table", headers: ["작업", "목표", "일반 펌프 방향", "핵심 검증"], rows: [["시료", "소량 흡입과 이송", "시린지·피스톤·피펫팅", "체적 정확도와 반복성"], ["시약", "정량 또는 시간 기반 공급", "정량 기구 또는 액체 펌프", "용량과 호환성"], ["세척/린스", "빠른 체적 교환", "소형 액체 다이어프램", "유량, 압력, 자흡, 잔류"], ["폐액", "가스·액체·혼합상 배출", "액체 또는 기액 다이어프램", "유체 상태, 진공도, 시간"]] }] },
  ...
  ru: {
    ...
    sections: [
      ...
      { title: "11. Типы насосов для задач тракта IVD", blocks: [{ type: "table", headers: ["Задача", "Цель", "Типичное направление", "Проверка"], rows: [["Проба", "Малый объём и перенос", "Шприцевой, поршневой или пипетирующий", "Точность и повторяемость"], ["Реагент", "Дозированная или временная подача", "Дозатор или жидкостный насос", "Доза и совместимость"], ["Мойка/ополаскивание", "Быстрый обмен объёма", "Жидкостный мембранный", "Расход, давление, запуск, остаток"], ["Отходы", "Удаление газа, жидкости или смеси", "Жидкостный или газожидкостный", "Состояние, вакуум и время"]] }] },
