...
/* =========================================================
   EnvironmentalMonitoringApplicationClient.tsx
   恒永达官网｜环保监测应用领域交互组件
========================================================= */
...
import type {
  ...
  EnvironmentalMonitoringApplicationType,
  EnvironmentalMonitoringFluidicModule,
} from "@/data/applications/environmental-monitoring/environmental-monitoring-application.types";

type EnvironmentalMonitoringApplicationClientProps = {
  data: EnvironmentalMonitoringApplicationPageData;
};
...
export default function EnvironmentalMonitoringApplicationClient({
  data,
}: EnvironmentalMonitoringApplicationClientProps) {
  ...
  const activeApplication = useMemo<EnvironmentalMonitoringApplicationType>(() => {
    return (
  ...
  const activeModule = useMemo<EnvironmentalMonitoringFluidicModule>(() => {
    return (
  ...
  function handleApplicationChange(application: EnvironmentalMonitoringApplicationType) {
  ...
  function handleModuleChange(module: EnvironmentalMonitoringFluidicModule) {
    setActiveModuleKey(module.key);
    setActiveProductKey(module.products[0] ?? "");
  }

  return (
    <main className="ivd-page environmental-monitoring-page">
      ...
      <section className="ivd-section" id="applications">
        <div className="ivd-section-inner">
          ...
          <div className="ivd-instrument-tabs" role="tablist" aria-label="环保监测类型">
